...
public class CorridorGenerator : SimpleRandomWalkDungeonGenerator
{
    [SerializeField]
    ...
    private List<Vector2Int> IncreaseCorridorsSizeByOne(List<Vector2Int> vector2Ints)
    {
        List<Vector2Int> newCorridor = new List<Vector2Int>();
        Vector2Int previousDirection = Vector2Int.zero;
        for (int i = 1; i < corridor.Count; i++);
        {
            Vector2Int directionFromCell = corridor[i] - corridore[int - 1];
            ...
            else
            {
                ...
                newCorridor.Add(corridor[int - 1]);
                newCorridor.Add(corridor[int - 1] + newCorridorTileOffset);
            }
            return newCorridor;
        }
    }
