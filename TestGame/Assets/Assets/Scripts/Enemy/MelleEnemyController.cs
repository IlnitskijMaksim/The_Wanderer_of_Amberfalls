...
public class test : MonoBehaviour
{
    ...
    private bool isFleeing = false;               // ‘лаг дл€ отслеживани€ состо€ни€ убегани€
    private float lastDamageTime;                 // ¬рем€ последнего удара
    private Transform player;                     // —сылка на игрока
    private NavMeshAgent agent;                   //  омпонент NavMeshAgent
    private Vector3 randomDestination;            // —лучайна€ точка назначени€
    private bool isChasing = false;               // ‘лаг дл€ отслеживани€ состо€ни€ преследовани€
    private bool shouldFollowPlayer = false;      // ‘лаг дл€ определени€, следовать ли за игроком после достижени€ случайной точки
